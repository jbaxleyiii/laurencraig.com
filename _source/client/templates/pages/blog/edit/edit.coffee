...
Template.blogAdminEdit.events
  ...
  "blur [data-bind-input], keyup [data-bind-input], paste [data-bind-input], copy [data-bind-input], cut [data-bind-input], mouseup [data-bind-input]": (e, tpl) ->
    $("[name=#{e.target.dataset.bindInput}]")[0].value =  $(e.target).text()

  "blur [data-bind-input=title]": (e, tpl) ->
  ...
  # Autosave
  # 'input .editable, keydown .editable, keydown .html-editor, blur [data-bind-input]': _.debounce (e, tpl) ->
  #   save tpl, (id, err) ->
  #     if err
